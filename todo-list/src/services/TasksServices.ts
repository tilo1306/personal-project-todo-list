...
export const createTask = async (id: string, task: string): Promise<itasks | Error> => {
...
export const updateTask = async (id: string, task: string, status: string): Promise<itasks | Error> => {
